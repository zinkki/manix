...
//AdminForm
export const AdminWrite = Loadable(lazy(() => import('../components/AdminWrite')));
export const AdminPFList = Loadable(lazy(()=> import('../components/AdminPFList')));
export const AdminVisit = Loadable(lazy(()=> import('../components/AdminVisit')));
...
export const AutomanixMain = Loadable(lazy(() => import('../pages/AutomanixMain')));
